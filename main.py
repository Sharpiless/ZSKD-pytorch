...
def main():
    ...
    parser.add_argument('--lr', type=int, default=3.0, help='learning rate')
    parser.add_argument('--iters', type=int, default=1500, help='iteration number')
    parser.add_argument('--wasserstein', type=bool, default=False, help='wether to use wasserstein distance.')
    ...
    if args.do_genimgs==True:
        zskd = ZSKD(args.dataset, teacher, args.num_sample, args.beta, args.t, args.batch_size, args.lr, args.iters, args.wasserstein)
